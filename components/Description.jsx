          ...
          <div className="max-auto max-w-2xl lg:max-w-5xl">
            <div className="max-w-2xl">
              ...
              <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
                I’m Sergio Serrano, a software engineer and entrepreneur based
                in Neiva-Colombia. I’m the founder and CEO of AceCode, where we
                develop technologies that change everything.
              </p>
              <div className="mt-6 flex gap-6" aria-label="Follow on twitter">
                <a
                ...
                <a
                  ...
                  href="https://www.instagram.com/sergio_serrano_ss/"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
                ...
                <a
                  ...
                  href="https://www.linkedin.com/in/sergio-serrano-guzman-511339253/"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
