            ...
            >
              {projects?.map((project) => (
                <li
                  ...
                  key={project.title}
                >
                  <div class="relative z-10 flex h-12 w-12 items-center  justify-center rounded-full bg-white shadow-md shadow-zinc-800/5 ring-1 ring-zinc-900/5 dark:border dark:border-zinc-700/50 dark:bg-white dark:ring-0">
                    <img
                      alt="Project about IA"
                      src={project.image}
                      width="32"
                      height="32"
                      decoding="async"
                  ...
                  <h2 class="mt-6 text-base font-semibold text-white dark:text-zinc-100">
